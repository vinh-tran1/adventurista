...
const FriendProfileView = ({ navigation }) => {
        ...
        {/* top half */}
            ...
            <View style={styles.bioBanner}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity 
                        style={{ backgroundColor: isFriend ? '#EDD3FF' : '#EFEFEF', marginLeft: 6, paddingVertical: 4, paddingHorizontal: 6, borderRadius: 5, borderWidth: 0.25, borderColor: 'gray'}}
                        onPress={handleAddFriend}
                        >
                        {isFriend ? (<Text style={{ fontSize: 12}}>Friend</Text>) : <Text style={{ fontSize: 12}}>Add Friend</Text>}
                    </TouchableOpacity>
                </View>
