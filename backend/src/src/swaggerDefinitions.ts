  ...
  paths: {
    ...
    "/users/unblock-user": {
      post: {
        ...
        description:
          "Unblock a user, allowing them to interact and view content again",
    ...
    "/users/profile-pic-presigned": {
      get: {
        ...
        description:
          "Returns a presigned URL for uploading profile picture to S3",
    ...
    "/events/event/create": {
      post: {
        ...
        description:
          "Creates a new event and registers it under the posting user's profile",
    ...
    "/events/who-is-going": {
      get: {
        ...
        description:
          "Returns a list of users who are marked as going to the specified event",
    ...
    "/events/who-is-going-ids": {
      get: {
        ...
        description:
          "Returns a list of user IDs who are marked as going to the specified event",
    ...
    "/events/cancel-going-to-event": {
      post: {
        ...
        description:
          "Marks a user as not going to an event they previously marked attendance for",
        ...
        responses: {
          ...
          "404": {
            description:
              "User or event not found or user was not marked as going",
          },
        },
      },
    },
    "/events/event-pic-presigned": {
      get: {
        ...
        description:
          "Returns a presigned URL for uploading an event picture to S3",
